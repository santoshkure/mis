...
<nav class="navbar top-navbar navbar-expand-md navbar-light">
    ...
    <div class="navbar-header">
        <a class="navbar-brand" href="{{ url('/home') }}">
            <!-- Logo icon -->
            <b><img src="{{ asset('img/logo.png') }}" alt="{{ config('app.name', 'Laravel') }}" class="logo dark-logo" /></b>
            <!--End Logo icon -->
            <!-- Logo text -->
            <span><img src="{{ asset('img/logo-text.png') }}" alt="{{ config('app.nae', 'Laravel') }}" class="logo-text dark-logo" /></span>
        </a>
    </div>
    <!-- End Logo -->
